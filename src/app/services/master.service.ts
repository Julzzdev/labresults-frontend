...
export class MasterService {
  ...
  public get = async (section: string) => {
    ...
    return await axios.get(`${this.host}${section}`)
  }
  // functions get id
  public getById = async (section: string, id: string) => {
    return await axios.get(`${this.host}${section}/${id}`)
  }
  // function post
  public post = async (section: string, body: any) => {
    const res=await axios.post(`${this.host}${section}`, body)
  ...
  public patch = async (section: string, body: any) => {
    return await axios.patch(`${this.host}${section}/${body['_id'] || body['id']}`, body)
  }
  // function delete 
  public delete = async (section: string, id: string) => {
    return await axios.delete(`${this.host}${section}/${id}`)
  }
  // control request
